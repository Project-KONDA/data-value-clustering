...
def silhouette_score_mean(distance_matrix, clusters):
    return silhouette_score(X=distance_matrix, labels=clusters, metric='precomputed')


def silhouette_score_samples(distance_matrix, clusters):
    return silhouette_samples(X=distance_matrix, labels=clusters, metric='precomputed')


def plot_silhouette_analysis(values, distance_matrix, clusters):
    ...
    silhouette_mean = silhouette_score_mean(distance_matrix, clusters)
    print("For n_clusters =", n_clusters,
          "The average silhouette_score is :", silhouette_mean)

    silhouette_samples = silhouette_score_samples(distance_matrix, clusters)
