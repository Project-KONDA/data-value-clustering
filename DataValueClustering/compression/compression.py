...
question_array = [
    ...
    [[0],          [1],  "lower_sequence", False,
     ...
     "Choose yes if the length of lower case letter sequences does not have a crucial impact on the meaning or if you"
     + " expect lower case letter sequences of heterogeneous length.",
    ...
    [[0, 1],       [],   "sequence", False,
     ...
     "'Portrait' and 'USA' will be treated equally since both consist of a sequence of lower, upper or mixed case"
     + " letters"],  # 4
    [[2],          [1],  "upper_sequence", False,
     "Should all upper case letter sequences be treated equally?",
     "Choose yes if the length of upper case letter sequences does not have a crucial impact on the meaning or if you"
     + " expect upper case letter sequences of heterogeneous length.",
    ...
    [[0, 3, 6],    [1],  "word_sequence", False,
     ...
     "Choose yes if the length of sequences of lower or upper case words does not have a crucial impact on the meaning"
     + " or if you expect sequences of lower or upper case words of heterogeneous length.",
     "'in Marburg' and 'brother or father' will be treated equally since both are sequences of words seperated by a "
     + "blank space"],  # 7
    [[0, 1, 4],    [],   "sequence_sequence", False,
     "Should all sequences of lower, upper or mixed case letter sequences seperated by a blank space be treated"
     + " equally?",
     "Choose yes if the length of sequences of lower, upper or mixed case letter sequences does not have a crucial"
     + " impact on the meaning or if you expect sequences of lower, upper or mixed case letter sequences of"
     + " heterogeneous length.",
     "'in USA' and 'around or in Marburg' will be treated equally since both are sequences of letter sequences"
     + " seperated by a blank"],  # 8
    ...
    [[9],          [],   "int", False,
     ...
     "Choose yes if the length of digit sequences does not have a crucial impact on the meaning or if you expect digit"
     + " sequences of heterogeneous length.",
    ...
    [[9, 10],      [],   "float", False,
     ...
     "Choose yes if the length of digit sequences preceding and following a comma does not have a crucial impact on the"
     + " meaning or if you expect pairs of digit sequences separated by a comma of heterogeneous length.",
