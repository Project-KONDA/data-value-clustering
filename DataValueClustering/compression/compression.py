...
compression_configuration_array = [
    ...
    [[0, 3],       [1, 6], lambda v: re.sub("[a-zäöüßáàéèíìóòúùøñçåâêëîïæœôûÿ]+", "s", v),                                              ],  # "s",  "lower_case_words",            "[a-zäöüß]+"],  # 2
    [[0, 3, 6],    [1, 7], lambda v: re.sub("[A-ZÄÖÜÁÀÉÈÍÌÓÒÚÙÑÅÂÇÊËÎÏÆÔŒÛŸ]?[a-zäöüßáàéèíìóòúùøñçåâêëîïæœôûÿ]+", "w", v),                                     ],  # "w",  "words",                       "[A-ZÄÖÜ]?[a-zäöüß]+"],  # 3
    [[0, 3, 6, 7], [1],    lambda v: re.sub("([A-ZÄÖÜÁÀÉÈÍÌÓÒÚÙÑÅÂÇÊËÎÏÆÔŒÛŸ]?[a-zäöüßáàéèíìóòúùøñçåâêëîïæœôûÿ]+ )* [A-ZÄÖÜÁÀÉÈÍÌÓÒÚÙÑÅÂÇÊËÎÏÆÔŒÛŸ]?[a-zäöüßáàéèíìóòúùøñçåâêëîïæœôûÿ]+", "q", v),             ],  # "q",  "word_sequences",              "([A-ZÄÖÜ]?[a-zäöüß]+ )* [A-ZÄÖÜ]?[a-zäöüß]+"],  # 4
    [[0, 1],       [4],    lambda v: re.sub("[a-zäöüßáàéèíìóòúùøñçåâêëîïæœôûÿA-ZÄÖÜÁÀÉÈÍÌÓÒÚÙÑÅÂÇÊËÎÏÆÔŒÛŸ]", "a", v),                                         ],  # "a",  "letters",                     "[a-zäöüßA-ZÄÖÜ]"],  # 5
    [[0, 1, 4],    [8],    lambda v: re.sub("[a-zäöüßáàéèíìóòúùøñçåâêëîïæœôûÿA-ZÄÖÜÁÀÉÈÍÌÓÒÚÙÑÅÂÇÊËÎÏÆÔŒÛŸ]+", "b", v),                                        ],  # "b",  "letter_sequences",            "[a-zäöüßA-ZÄÖÜ]+"],  # 6
    [[0, 1, 4, 8], [],     lambda v: re.sub("([a-zäöüßáàéèíìóòúùøñçåâêëîïæœôûÿA-ZÄÖÜÁÀÉÈÍÌÓÒÚÙÑÅÂÇÊËÎÏÆÔŒÛŸ]+ )*[a-zäöüßáàéèíìóòúùøñçåâêëîïæœôûÿA-ZÄÖÜÁÀÉÈÍÌÓÒÚÙÑÅÂÇÊËÎÏÆÔŒÛŸ]+", "Q", v),                    ],  # "Q",  "letter_sequence_sequences",   "([a-zäöüßA-ZÄÖÜ]+ )*[a-zäöüßA-ZÄÖÜ]+"],  # 7
    [[2],          [1, 5], lambda v: re.sub("[A-ZÄÖÜÁÀÉÈÍÌÓÒÚÙÑÅÂÇÊËÎÏÆÔŒÛŸ]", "L", v),                                                ],  # "L",  "upper_case_letters",          "[A-ZÄÖÜ]"],  # 8
    [[2, 5],       [1],    lambda v: re.sub("[A-ZÄÖÜÁÀÉÈÍÌÓÒÚÙÑÅÂÇÊËÎÏÆÔŒÛŸ]+", "S", v),                                               ],  # "S",  "upper_case_letter_sequences", "[A-ZÄÖÜ]+"],  # 9
    ...
    [[17],         [12],   lambda v: re.sub("[^a-zäöüßáàéèíìóòúùøñçåâêëîïæœôûÿA-ZÄÖÜÁÀÉÈÍÌÓÒÚÙÑÅÂÇÊËÎÏÆÔŒÛŸ0-9 \.,:;!\?\(\)\[\]\{\}\+\-\*/%=<>\&\|]", "_", v), ],  # "_",  "other_characters",            "[^a-zäöüßA-ZÄÖÜ0-9 \.,:;!\?\(\)\[\]\{\}\+\-\*/%=<>\&\|]"],  # 17
    [[12],         [],     lambda v: re.sub("[^a-zäöüßáàéèíìóòúùøñçåâêëîïæœôûÿA-ZÄÖÜÁÀÉÈÍÌÓÒÚÙÑÅÂÇÊËÎÏÆÔŒÛŸ0-9 ]", "§", v),                                    ],  # "\$", "special_characters",          "[^a-zäöüßA-ZÄÖÜ0-9 ]"]  # 18
]
