...
if __name__ == '__main__':
    ...
    regex = ["", "ante", "0123456789", "abcdefghijklmnopqrstuvwxyzäöüßáàéèíìóòúùABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜÁÀÉÈÍÌÓÒÚÙ", "\-", "<rest>"]
    weights = [
        # a    r
        [ 0,  1,  2,  4,  8, 16],  #
        [ 1,  1,  2,  4,  8, 16],  # ante
    ...
    algorithm_params = [['method', 'complete'], ['n_clusters', 40], ['distance_threshold', None], ['criterion', 'maxclust']]  # complete, ward, average, weighted, centroid, median, single
    ...
    # initialize
    object = ExecutionConfigurationFromParams(midas_dates, 0, 1000000, compression_answers,
