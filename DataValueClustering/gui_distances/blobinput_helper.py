...
blob_configuration_array = [
    ...
    [[],           [0],                      "lower_case_letters",          "abcdefghijklmnopqrstuvwxyzäöüßáàãéèíìóòōúùøñçčåâêěëîïæœôûřṙÿýṭţžşūšēőżůćłęĺļıḫńņňṇǰǐṣąűśḥĉõźāăğīķ",                                               True,
    ...
    [[],           [1, 2],                   "upper_case_letters",          "ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜÁÀÉÈĚĖÍÌÓÒŌÚÙÑÅÂÃĶÇČÊËÎÏḤŚŠṢŁŘÆÔŒÛŸŻŽḪṬǦŞ",                                                True,
    ...
    [[17],         [12],                     "other_characters",            "§",                                                       False,
     "'§' represents all characters that are not letters, digits, blank space, punctuation marks, brackets, math operators or quotation marks. "],
    [[],           [12, 17],                 "other_characters",            "_", True,
     "'_' represents all other characters."],
