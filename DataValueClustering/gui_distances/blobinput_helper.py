...
blob_configuration_array = [
    ...
    [[],           [0],                      "lower_case_letters",          "abcdefghijklmnopqrstuvwxyzäöüßáàãéèíìóòōúùøñçčåâêěëîïæœôûřṙÿýṭţžşūšēőżůćłęĺļıńņňṇǰǐṣąűśḥĉõźāă",                                               True,
    ...
    [[],           [1, 2],                   "upper_case_letters",          "ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜÁÀÉÈĚĖÍÌÓÒŌÚÙÑÅÂÃĶÇČÊËÎÏḤŚŠṢŁŘÆÔŒÛŸŻŽ",                                                True,
