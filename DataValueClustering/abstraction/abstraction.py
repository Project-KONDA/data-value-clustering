...
abstraction_configuration_array = [
    ...
    [[0, 3, 6, 7], [1],    lambda v: re.sub("(w )+w", "q", re.sub("[A-ZÄÖÜÁÀÉÈÍÌÓÒÚÙÑÅÂÇÊËÎÏÆÔŒÛŸ]?[a-zäöüßáàéèíìóòúùøñçåâêëîïæœôûÿ]+", "w", v)),              ],  # "q",  "word_sequences",              "([A-ZÄÖÜ]?[a-zäöüß]+ )* [A-ZÄÖÜ]?[a-zäöüß]+"],  # 4
    ...
    [[0, 1, 4, 8], [],     lambda v: re.sub("(b )+b", "Q", re.sub("[a-zäöüßáàéèíìóòúùøñçåâêëîïæœôûÿA-ZÄÖÜÁÀÉÈÍÌÓÒÚÙÑÅÂÇÊËÎÏÆÔŒÛŸ]+", "b", v)),                 ],  # "Q",  "letter_sequence_sequences",   "([a-zäöüßA-ZÄÖÜ]+ )*[a-zäöüßA-ZÄÖÜ]+"],  # 7
    ...
    [[17],         [12],   lambda v: re.sub("[^a-zäöüßáàãéèíìóòōúùøñçčåâêěëîïæœôûřÿŠýŁṭžşūšēőżĖṢůćłęŚĺḤńǰǐṣŻŽąűśḥĉõźāA-ZÄÖÜÁÀÉÈĚÍÌÓÒŌÚÙÑÅÂÃÇČÊËÎÏŘÆÔŒÛŸ0-9 \.,:;!\?\(\)\[\]\{\}\+\-\*/%=<>\&\|\"`´']", "_", v), ],  # "_",  "other_characters",            "[^a-zäöüßA-ZÄÖÜ0-9 \.,:;!\?\(\)\[\]\{\}\+\-\*/%=<>\&\|]"],  # 17
    [[12],         [],     lambda v: re.sub("[^a-zäöüßáàãéèíìóòōúùøñçčåâêěëîïæœôûřÿŠýŁṭžşūšēőżĖṢůćłęŚĺḤńǰǐṣŻŽąűśḥĉõźāA-ZÄÖÜÁÀÉÈĚÍÌÓÒŌÚÙÑÅÂÃÇČÊËÎÏŘÆÔŒÛŸ0-9 ]", "§", v),                                    ],  # "\$", "special_characters",          "[^a-zäöüßA-ZÄÖÜ0-9 ]"]  # 18
]
