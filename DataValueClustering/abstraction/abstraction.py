...
abstraction_configuration_array = [
    ...
    [[0],          [1, 3], lambda v: re.sub("[a-zäöüßáàãéèíìóòōúùøñçčåâêěëîïæœôûřṙÿýṭţžşūšēőżůćłęĺļıḫńņňṇǰǐṣąűśḥĉõźāăğīķ]", "l", v),                                               ],  # "l",  "lower_case_letters",          "[a-zäöüß]"],  # 1
    [[0, 3],       [1, 6], lambda v: re.sub("[a-zäöüßáàãéèíìóòōúùøñçčåâêěëîïæœôûřṙÿýṭţžşūšēőżůćłęĺļıḫńņňṇǰǐṣąűśḥĉõźāăğīķ]+", "s", v),                                              ],  # "s",  "lower_case_words",            "[a-zäöüß]+"],  # 2
    [[0, 3, 6],    [1, 7], lambda v: re.sub("[A-ZÄÖÜÁÀÉÈĚĖÍÌÓÒŌÚÙÑÅÂÃĶÇČÊËÎÏḤŚŠṢŁŘÆÔŒÛŸŻŽḪṬǦŞ]?[a-zäöüßáàãéèíìóòōúùøñçčåâêěëîïæœôûřṙÿýṭţžşūšēőżůćłęĺļıḫńņňṇǰǐṣąűśḥĉõźāăğīķ]+", "w", v),                                     ],  # "w",  "words",                       "[A-ZÄÖÜ]?[a-zäöüß]+"],  # 3
    [[0, 3, 6, 7], [1],    lambda v: re.sub("(w )+w", "q", re.sub("[A-ZÄÖÜÁÀÉÈĚĖÍÌÓÒŌÚÙÑÅÂÃĶÇČÊËÎÏḤŚŠṢŁŘÆÔŒÛŸŻŽḪṬǦŞ]?[a-zäöüßáàãéèíìóòōúùøñçčåâêěëîïæœôûřṙÿýṭţžşūšēőżůćłęĺļıḫńņňṇǰǐṣąűśḥĉõźāăğīķ]+", "w", v)),              ],  # "q",  "word_sequences",              "([A-ZÄÖÜ]?[a-zäöüß]+ )* [A-ZÄÖÜ]?[a-zäöüß]+"],  # 4
    [[0, 1],       [4],    lambda v: re.sub("[a-zäöüßáàãéèíìóòōúùøñçčåâêěëîïæœôûřṙÿýṭţžşūšēőżůćłęĺļıḫńņňṇǰǐṣąűśḥĉõźāăğīķA-ZÄÖÜÁÀÉÈĚĖÍÌÓÒŌÚÙÑÅÂÃĶÇČÊËÎÏḤŚŠṢŁŘÆÔŒÛŸŻŽḪṬǦŞ]", "a", v),                                         ],  # "a",  "letters",                     "[a-zäöüßA-ZÄÖÜ]"],  # 5
    [[0, 1, 4],    [8],    lambda v: re.sub("[a-zäöüßáàãéèíìóòōúùøñçčåâêěëîïæœôûřṙÿýṭţžşūšēőżůćłęĺļıḫńņňṇǰǐṣąűśḥĉõźāăğīķA-ZÄÖÜÁÀÉÈĚĖÍÌÓÒŌÚÙÑÅÂÃĶÇČÊËÎÏḤŚŠṢŁŘÆÔŒÛŸŻŽḪṬǦŞ]+", "b", v),                                        ],  # "b",  "letter_sequences",            "[a-zäöüßA-ZÄÖÜ]+"],  # 6
    [[0, 1, 4, 8], [],     lambda v: re.sub("(b )+b", "Q", re.sub("[a-zäöüßáàãéèíìóòōúùøñçčåâêěëîïæœôûřṙÿýṭţžşūšēőżůćłęĺļıḫńņňṇǰǐṣąűśḥĉõźāăğīķA-ZÄÖÜÁÀÉÈĚĖÍÌÓÒŌÚÙÑÅÂÃĶÇČÊËÎÏḤŚŠṢŁŘÆÔŒÛŸŻŽḪṬǦŞ]+", "b", v)),                 ],  # "Q",  "letter_sequence_sequences",   "([a-zäöüßA-ZÄÖÜ]+ )*[a-zäöüßA-ZÄÖÜ]+"],  # 7
    [[2],          [1, 5], lambda v: re.sub("[A-ZÄÖÜÁÀÉÈĚĖÍÌÓÒŌÚÙÑÅÂÃĶÇČÊËÎÏḤŚŠṢŁŘÆÔŒÛŸŻŽḪṬǦŞ]", "L", v),                                                                        ],  # "L",  "upper_case_letters",          "[A-ZÄÖÜ]"],  # 8
    [[2, 5],       [1],    lambda v: re.sub("[A-ZÄÖÜÁÀÉÈĚĖÍÌÓÒŌÚÙÑÅÂÃĶÇČÊËÎÏḤŚŠṢŁŘÆÔŒÛŸŻŽḪṬǦŞ]+", "S", v),                                                                       ],  # "S",  "upper_case_letter_sequences", "[A-ZÄÖÜ]+"],  # 9
    ...
    [[17],         [12],   lambda v: re.sub("[^a-zäöüßáàãéèíìóòōúùøñçčåâêěëîïæœôûřṙÿýṭţžşūšēőżůćłęĺļıḫńņňṇǰǐṣąűśḥĉõźāăğīķA-ZÄÖÜÁÀÉÈĚĖÍÌÓÒŌÚÙÑÅÂÃĶÇČÊËÎÏḤŚŠṢŁŘÆÔŒÛŸŻŽḪṬǦŞ0-9 \.,:;!\?—\(\)\[\]\{\}\+\-\*/%=~<>\^\&\|\"`´'»«’›‹‚‘]", "§", v), ],  # "_",  "other_characters",            "[^a-zäöüßA-ZÄÖÜ0-9 \.,:;!\?\(\)\[\]\{\}\+\-\*/%=<>\&\|]"],  # 17
    [[12],         [],     lambda v: re.sub("[^a-zäöüßáàãéèíìóòōúùøñçčåâêěëîïæœôûřṙÿýṭţžşūšēőżůćłęĺļıḫńņňṇǰǐṣąűśḥĉõźāăğīķA-ZÄÖÜÁÀÉÈĚĖÍÌÓÒŌÚÙÑÅÂÃĶÇČÊËÎÏḤŚŠṢŁŘÆÔŒÛŸŻŽḪṬǦŞ0-9 ]", "§", v),                                    ],  # "\$", "special_characters",          "[^a-zäöüßA-ZÄÖÜ0-9 ]"]  # 18
]
