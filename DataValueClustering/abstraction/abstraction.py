...
abstraction_configuration_array = [
    ...
    [[17],         [12],   lambda v: re.sub("[^a-zäöüßáàãéèíìóòōúùøñçčåâêěëîïæœôûřÿŠýŁṭžşūšēőżĖṢůćłęŚĺḤńǰǐṣŻŽąűśḥĉõźāA-ZÄÖÜÁÀÉÈĚÍÌÓÒŌÚÙÑÅÂÃÇČÊËÎÏŘÆÔŒÛŸ0-9 \.,:;!\?\(\)\[\]\{\}\+\-\*/%=<>\&\|\"`´']", "§", v), ],  # "_",  "other_characters",            "[^a-zäöüßA-ZÄÖÜ0-9 \.,:;!\?\(\)\[\]\{\}\+\-\*/%=<>\&\|]"],  # 17
