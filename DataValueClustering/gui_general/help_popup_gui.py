...
def menu_help_result(master):
    ...
    text = [
        "The Clustering Result & Evaluation view provides information on the calculated clustering and supports you "
        "in validating it.",
        ...
        "Each dot represents an abstracted data value. The",
        "distances between the dots represent the dissimilarities between the abstracted data values. "
        "Therefore, the closer the",
        "points are, the similar the values are.",
        "Each cluster is represented by a different color. "
        "The noisy values are presented in black.",
        "This plot allows you to quickly get an overview of the compactness and separation of the clustering. "
        "A clustering is",
        "compact if there is a high similarity within clusters and it is separate if there is a low "
        "similarity between clusters.",
        "In general, a good clustering should have high compactness and separation.",
        "If the colors are very mixed, this may hint at low meaningfulness of the clustering "
        ...
        "If the excel file is not created, you first must specify the save path.",
        "",
        ...
        " • The third sheet additionally shows the variance within each cluster and the dissimilarity of each value "
        "to the others",
        "   in the same cluster.",
        "An extremely high variance within a cluster indicates that you should consider analysing this cluster "
        "separately (cf. ",
        "evaluation question 4) as it may be too heterogeneous to oversee the types of contained values.",
        "You should further take a look at values with an extremely high dissimilarity to the other values in the "
        "same cluster,",
        "as it may be significantly different from those.",
        "",
        ["Evaluation"],
        "After having familiarized yourself with the clustering, you should validate the clustering, i.e. find out "
        "whether you are",
        "satisfied with the clustering or need another iteration with a modified configuration. "
        "The evaluation questionnaire given",
        "on the right-hand side, supports this process. ",
        "In case you are not satisfied with the clustering, we calculate suggestions for modifications "
        "of the configuration of the ",
        "next iteration. The suggestions are given in the configuration views in blue text.",
        "",
        ["Confirm & Discard"],
...
def menu_help_clustering_configuration(master):
    ...
    text = [
        ...
        "You can specify the ",
        "parameter values via three types of input:",
        ...
        "value to the default value, press the 'Reset' button.",
        ...
        "",
        ["Optional"],
        "Some parameters are optional or only used under specific circumstances. "
        "When they are not used, they are greyed out. ",
        "Optional parameters and be enabled and disabled via a checkbox on the left-hand side.",
        "",
        ["Dependencies"],
...
def menu_help_clustering_selection(master):
    ...
    text = [
        ...
        "",
        ["Questionnaire"],
        "To have a reference point, which algorithm is the most fitting for your purpose, "
        "we offer a short questionaire on the left-hand side.",
        "",
        ["Algorithm Selection"],
...
def menu_help_distance_slider(master):
    ...
    text = [
        ...
        "Thus, heigher weights for a character group mean more dissimilarity caused by the presence of these",
...
def menu_help_distance_choice(master):
    ...
    text = [
        ...
        "the easiest method, the Sliders View.",
        "Further note that once you use the Sliders or Matrix View, you cannot open your configuration via the Blobs",
        "View.",
        "",
        "To confirm your selection, press the 'OK' button.",
        "To discard your selection, press the 'X' button in the upper right corner.",
...
def menu_help_abstraction(master):
    ...
    text = [
        "The Abstraction Configuration view allows you to configure the abstraction from irrelevant features of the",
        "data values.",
        ...
        "When answering the questions, please use your domain knowledge about the selected data and data field to",
        "decide which features of the data values are irrelevant for clustering.",
...
def menu_help_data_add(master):
    ...
    text = [
        "The Data Addition view allows you to add a data set to the list of supported data sets selectable in the",
        "Select Data view.",
...
def menu_help_data_selection(master):
    ...
    text = [
        ...
        "To remove a data set, press the '-' button below, but be careful as once removed data sets cannot be",
        "recovered.",
        "",
...
def menu_help_hub(master):
    ...
    text = [
        ...
        "The data value clustering requires you to perform 4 configuration steps:",
        ...
        "",
        ["Configuration"],
        "The configuration steps are performed in separate views which are opened upon clicking the corresponding",
        "button in the hub view.",
        "The configuration step required to be performed next is highlighted in blue.",
        "We advice you to perform the configuration steps from top to bottom, even though in some cases a different ",
        "order is possible.",
        ...
        "But since dissimilarity calculation and clustering may take up to multiple hours, they are startet manually",
        "by pressing the corresponding play button.",
