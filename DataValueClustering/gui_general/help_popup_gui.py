...
def menu_help_distance_slider(master):
    ...
    text = [
        ...
        "You can add and remove groups, i.e. lines via the '+' and '-' buttons.",
        "The default groups are automatically derived from the abstraction configuration and serve as a godd starting point.",
...
def menu_help_distance_choice(master):
    ...
    text = [
        ...
        "Further note that once you use the Sliders or Matrix View, you cannot open your configuration via the Blobs View.",
        "",
        "To confirm your selection, press the 'OK' button.",
        "To discard your selection, press the 'x' button in the upper right corner.",
    ]
...
def menu_help_abstraction(master):
    ...
    text = [
        ...
        "which features of the data values are irrelevant for clustering.",
